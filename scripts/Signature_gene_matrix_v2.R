...
ggsave(filename = paste0(outdir,"/","tSNE_all_",TPM_cutoff,"_",TSS_cutoff,"_",Num,"_perplexity",i,".pdf"), width =  9, height = 7)
},
error = function(e){
...
ggsave(filename = paste0(outdir,"/","tSNE_sig_",TPM_cutoff,"_",TSS_cutoff,"_",Num,"_perplexity",i,".pdf"), width =  9, height = 7)
},
error = function(e){
message("seem err in tSNE")
}
